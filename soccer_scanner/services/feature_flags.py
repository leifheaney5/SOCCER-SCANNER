...
FEATURE_FLAGS = (
    ...
    FeatureFlag('streaming_logos', True, 'design', '2026-12-31',
                'Local streaming-service logo assets with generic fallbacks.'),
    ...
    FeatureFlag('search', True, 'engineering', '2026-12-31',
