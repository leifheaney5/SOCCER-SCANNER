...
```json
{
  ...
  "note": "Multi-country competitions (UEFA Champions League, Europa League, Copa Libertadores, World Cup qualifiers) are deliberately absent: they have no single country and must not be forced into one.",
  "competitions": [
    ...
    {"canonicalId": "la-liga", "aliases": ["laliga", "la liga", "primera division"], "country": "Spain"},
    ...
    {"canonicalId": "mls", "aliases": ["mls", "major league soccer"], "country": "United States"},
